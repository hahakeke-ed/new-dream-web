...
export default function HeritagePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F6] text-[#2C3E50] font-sans selection:bg-[#D4AF37] selection:text-white">
      ...
      <footer className="bg-[#F9F8F6] py-12 px-6 border-t border-gray-200">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 tracking-widest uppercase">
